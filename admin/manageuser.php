...
<h1>Manage User</h1>
  <table class="rwd-table">
    <tbody>
      ...
      <?php
      $sql = "SELECT srno,fname,lname,Gender,email,UserName FROM user_details WHERE user IN ('user', 'paiduser')";
      ...
      while($row = mysqli_fetch_array($result))
      {
        ...
        echo "<td data-th='Delete'><a class='btn' href=\"delete.php?id=".$row[0]."\">Delete</a></td>";
        echo '</tr>';
      }
    ?>
