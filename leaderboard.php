...
<head>
  ...
  <meta charset="UTF-8">
  <title>CodePen - Leaderboard Example</title>
...
<body translate="no" >
  <div class="l-wrapper">
  <div class="c-header"><img class="c-logo" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/813538/km-logo-color.svg" draggable="false"/>
    <button class="c-button c-button--primary">Send Course</button>
  </div>
  <div class="l-grid">
          ...
          <ul class="c-list" id="list">
            <li class="c-list__item">
              <div class="c-list__grid">
                ...
                <div class="u-text--right u-text--small u-text--medium"># of Course</div>
              </div>
            </li>
          </ul>
        </div>
...
team.forEach(member => {
  ...
  newRow.innerHTML = `
		<div class="c-list__grid">
			...
			<div class="u-text--right c-Course">
				<div class="u-mt--8">
					<strong>${member.Course}</strong> ${randomEmoji()}
				</div>
			</div>
		</div>
	`;
  if (member.rank === 1) {
    ...
    newRow.querySelector('.c-Course').classList.add('u-text--yellow');
  } else if (member.rank === 2) {
    newRow.querySelector('.c-place').classList.add('u-text--dark');
    newRow.querySelector('.c-place').classList.add('u-bg--teal');
    newRow.querySelector('.c-Course').classList.add('u-text--teal');
  } else if (member.rank === 3) {
    newRow.querySelector('.c-place').classList.add('u-text--dark');
    newRow.querySelector('.c-place').classList.add('u-bg--orange');
    newRow.querySelector('.c-Course').classList.add('u-text--orange');
  }
  list.appendChild(newRow);
});

// Find Winner from sent Course by sorting the drivers in the team array
